...
/*
measure distance and show on serial monitor
  less than min range (1 inch) or greater than max range (157 inch)
    print out of range
...
void loop() {
    ...
    digitalWrite(PIN_TRIGGER, LOW);
    // after this, ultrasonic sends 8 short pulses

    // pulseIn - measure time
    //  returns the length of time for a signal to change L->H or H->L
