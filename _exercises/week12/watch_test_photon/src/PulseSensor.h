...
// SparkIntervalTimer uses hardware timers that are otherwise allocated for PIN
// functions (ADC/PWM) The first allocated timer is TIMR2 on Core and TIMR3 on
// Photon which is assigned to A0 & A1 ADC/PWM channels So use A2 (though A0 &
// A1 ADC should still work on Core and not affected on Photon) for pulse input,
