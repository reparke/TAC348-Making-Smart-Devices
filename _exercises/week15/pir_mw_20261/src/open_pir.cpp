...
/*
    some components need a pullup resistor (large resistor >=10K to power)
        ex: button 
    when we use the button, we connect one leg of the button to 3.3v with a 10K resistor
    ...
    INPUT_PULLUP internally connects the input pin to very large internal resistor
    ...
    - to adjust sensitivity, you could use a millis for how long "motion is detected" before you trigger alarm
*/
