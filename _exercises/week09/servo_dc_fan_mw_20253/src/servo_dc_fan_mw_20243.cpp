...
/*
    ...
    idea 3: millis
        servo stars at 15, increase by a fixed amount each time the timer goes off
        when servo gets to 165, start decreases now until 15, and flip and repeat
...
*/    
    ...
    /*
        DC motors and servos both use PWM, but at diff freq and they are not compatible
        SO! if we are combining DC motors and servo, we need to specify the PWM
            freq explicitly for the DC motor
    */
